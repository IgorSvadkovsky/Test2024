...
public class StreamsPrimitives {
    public static void main(String[] args) {
        ...
        IntSummaryStatistics summaryStatistics = listStr.stream()
                .map(Integer::valueOf)
                .mapToInt(Integer::intValue)
                .summaryStatistics();
        ...
        // Создание стримов примитивов

        var intStream1 = IntStream.of(1, 2, 3);

        DoubleStream.generate(Math::random);

        IntStream.range(1, 100); // не включая 100
        IntStream.rangeClosed(1, 100); // включая 100
